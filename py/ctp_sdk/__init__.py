...
from ctp_sdk.utility import register

# Load features
from ctp_sdk.feature.base_feature import CtpBaseFeature
from ctp_sdk.features import _has_feature, _make_feature
...
class CtpSDK:
    ...
    def get_utility(self):
        return CtpUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("CtpSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def JsonApi(self, data=None) -> "JsonApiEntity":
        ...
        from ctp_sdk.entity.json_api_entity import JsonApiEntity
    ...
    def Plugin(self, data=None) -> "PluginEntity":
        ...
        from ctp_sdk.entity.plugin_entity import PluginEntity
    ...
    def PluginApi(self, data=None) -> "PluginApiEntity":
        ...
        from ctp_sdk.entity.plugin_api_entity import PluginApiEntity
