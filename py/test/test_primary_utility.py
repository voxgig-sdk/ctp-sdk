...
from ctp_sdk.core.response import CtpResponse
from ctp_sdk.core.operation import CtpOperation
from ctp_sdk.core.error import CtpError
from ctp_sdk.core import helpers
from ctp_sdk.feature.base_feature import CtpBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = CtpSDK.test(None, None)
        ...
        class TestInitFeature(CtpBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(CtpBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = CtpSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = CtpSDK.test(None, setup_opts)
