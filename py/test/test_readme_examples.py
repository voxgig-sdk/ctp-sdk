# Ctp SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions CtpSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both CtpSDK(...) and CtpSDK.test(...) become
#      CtpSDK.test({"entity": {...}}) seeding one mock record (id "test01")
