...
class CtpTestRunner
{
    ...
    {
        $live = self::getenv('CTP_TEST_LIVE');
        $override = self::getenv('CTP_TEST_OVERRIDE');
        ...
        $explain = self::getenv('CTP_TEST_EXPLAIN');
...
class_alias('CtpTestRunner', 'Runner');
class_alias('CtpHelpers', 'Helpers');
