...
// Ctp SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (CtpSDK::test)
...
{
    private const SDK_CLASS = 'CtpSDK';
    ...
    private const SDK_BASE = 'ctp_sdk';
