...
The PHP SDK for the Ctp API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->JsonApi(null)->load(["id" => "example_id"], null);
...
[$result, $err] = $client->Ctp(null)->load(
    ["id" => "test01"], null
);
