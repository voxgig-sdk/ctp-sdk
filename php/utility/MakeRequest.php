...
// Ctp SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class CtpMakeRequest
{
    public static function call(CtpContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new CtpResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new CtpResponse($fetched);
        } else {
