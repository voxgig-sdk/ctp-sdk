...
class CtpTimeoutFeature extends CtpBaseFeature
{
    ...
    private function _with_timeout(CtpContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(CtpContext $_ctx, float $ms): void
    {
        $client = $this->client;
