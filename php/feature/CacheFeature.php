...
class CtpCacheFeature extends CtpBaseFeature
{
    ...
    private function _through(CtpContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
