...
class CtpStreamingFeature extends CtpBaseFeature
{
    ...
    private function _iterate(CtpResult $result): \Generator
    {
    ...
    private function _streamable(CtpContext $ctx): bool
    {
