...
class CtpRatelimitFeature extends CtpBaseFeature
{
    ...
    private function _acquire(CtpContext $ctx): void
    {
    ...
    private function _track(CtpContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
