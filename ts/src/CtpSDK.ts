...
class CtpSDK {
  ...
  async graphql(query: string, variables?: any, ctrl?: any) {
    ...
    if (null != errors && Array.isArray(errors) && 0 < errors.length) {
      ...
      const err: any = new Error('CtpSDK: graphql: ' +
  ...
  JsonApi(entopts?: Record<string, any>) {
    const self = this
    return new JsonApiEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  PluginApi(entopts?: Record<string, any>) {
    const self = this
    return new PluginApiEntity(self, entopts)
  }
