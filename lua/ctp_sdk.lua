...
CtpSDK._make_feature = _make_feature


function CtpSDK.new(options)
  local self = setmetatable({}, CtpSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function CtpSDK:get_utility()
  return Utility.copy(self._utility)
end


function CtpSDK:get_root_ctx()
  return self._rootctx
end


function CtpSDK:prepare(fetchargs)
...
function CtpSDK:direct(fetchargs)
...
-- by passing it.
function CtpSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function CtpSDK:graphql(query, variables, ctrl)
...
function CtpSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
