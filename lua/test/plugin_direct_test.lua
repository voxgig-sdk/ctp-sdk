...
describe("PluginDirect", function()
  it("should direct-load-plugin", function()
    local setup = plugin_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-plugin", setup.live and "live" or "unit")
...
function plugin_direct_setup(mockres)
