...
describe("JsonApiDirect", function()
  it("should direct-load-json_api", function()
    local setup = json_api_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-json_api", setup.live and "live" or "unit")
...
function json_api_direct_setup(mockres)
