...
describe("PluginApiDirect", function()
  it("should direct-load-plugin_api", function()
    local setup = plugin_api_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-plugin_api", setup.live and "live" or "unit")
...
function plugin_api_direct_setup(mockres)
