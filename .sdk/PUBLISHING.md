...
|---|---|---|
| `ts/` | @voxgig-sdk/ctp-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/ctp-sdk \
      --repository voxgig-sdk/ctp-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/ctp-sdk` shows it, and
`npm trust revoke @voxgig-sdk/ctp-sdk --id=<id>` removes it.
