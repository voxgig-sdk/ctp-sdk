...
class CtpTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = CtpTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = CtpTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = CtpTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
