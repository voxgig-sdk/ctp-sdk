...
// Ctp SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class CtpTestFeature extends CtpBaseFeature
{
    ...
    public function init(CtpContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (CtpContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (CtpContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(CtpContext $ctx, $op, $args): array
    {
