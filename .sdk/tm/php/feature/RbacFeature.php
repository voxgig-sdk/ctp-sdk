...
class CtpRbacFeature extends CtpBaseFeature
{
    ...
    private function _required(CtpContext $ctx): ?string
    {
    ...
    private function _reject(CtpContext $ctx, string $required): void
    {
    ...
    private function _track(CtpContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
