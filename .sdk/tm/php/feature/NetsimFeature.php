...
class CtpNetsimFeature extends CtpBaseFeature
{
    ...
    private function _simulate(CtpContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(CtpContext $ctx, array $applied): void
    {
        $client = $this->client;
