...
class CtpFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; CtpSDK/1.0)';
    ...
    public static function call(CtpContext $ctx, string $fullurl, array $fetchdef): array
    {
