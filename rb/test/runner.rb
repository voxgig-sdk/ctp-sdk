...
module CtpTestRunner
  ...
  def self.env_override(m)
    live = getenv("CTP_TEST_LIVE")
    override = getenv("CTP_TEST_OVERRIDE")
    ...
    explain = getenv("CTP_TEST_EXPLAIN")
    m["CTP_TEST_EXPLAIN"] = explain if explain && !explain.empty?
