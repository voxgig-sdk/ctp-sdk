...
The CTP API provides integration methods for connecting the functionality and content of the Chinese Text Project with external web applications.

Learn more about CTP API at [ctext.org](https://ctext.org).
...
This SDK exposes the API as a small set of **semantic entities** — JsonApi, Plugin and PluginApi — that you
...
const jsonapi = await client.JsonApi().load({ urn: "example" })
```
...
| Go CLI | `github.com/voxgig-sdk/ctp-sdk/go-cli` | `go install github.com/voxgig-sdk/ctp-sdk/go-cli/cmd/ctp@latest` |
| Go MCP server | `github.com/voxgig-sdk/ctp-sdk/go-mcp` | `go get github.com/voxgig-sdk/ctp-sdk/go-mcp@latest` |
