...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/ctp` | `npm install @voxgig-sdk/ctp` |
| Python | `voxgig-sdk-ctp` | `pip install voxgig-sdk-ctp` |
| PHP | `voxgig-sdk/ctp` | `composer require voxgig-sdk/ctp` |
| Golang | `github.com/voxgig-sdk/ctp-sdk/go` | `go get github.com/voxgig-sdk/ctp-sdk/go` |
| Ruby | `voxgig-sdk-ctp` | `gem install voxgig-sdk-ctp` |
| Lua | `voxgig-sdk-ctp` | `luarocks install voxgig-sdk-ctp` |
