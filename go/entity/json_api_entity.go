...
func NewJsonApiEntity(client *core.CtpSDK, entopts map[string]any) *JsonApiEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *JsonApiEntity) GetName() string { return e.name }
...
func (e *JsonApiEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *JsonApiEntity) Deleted() bool {
	return e.deleted
}


func (e *JsonApiEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewJsonApiEntity(e.client, opts)
}

func (e *JsonApiEntity) Data(args ...any) any {
...
func (e *JsonApiEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an JsonApi; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *JsonApiEntity) DataTyped(data ...JsonApi) JsonApi {
	if len(data) > 0 {
		return typedFrom[JsonApi](e.Data(asMap(data[0])))
	}
	return typedFrom[JsonApi](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through JsonApi (all fields
// optional at the wire level).
func (e *JsonApiEntity) MatchTyped(match ...JsonApi) JsonApi {
	if len(match) > 0 {
		return typedFrom[JsonApi](e.Match(asMap(match[0])))
	}
	return typedFrom[JsonApi](e.Match())
}
...
func (e *JsonApiEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *JsonApiEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// JsonApiLoadMatch and returns an JsonApi. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *JsonApiEntity) LoadTyped(reqmatch JsonApiLoadMatch, ctrl map[string]any) (JsonApi, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return JsonApi{}, err
	}
	return typedFrom[JsonApi](res), nil
}



func (e *JsonApiEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *JsonApiEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *JsonApiEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *JsonApiEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *JsonApiEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
