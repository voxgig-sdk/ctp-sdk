...
func NewPluginEntity(client *core.CtpSDK, entopts map[string]any) *PluginEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PluginEntity) GetName() string { return e.name }
...
func (e *PluginEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PluginEntity) Deleted() bool {
	return e.deleted
}


func (e *PluginEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPluginEntity(e.client, opts)
}

func (e *PluginEntity) Data(args ...any) any {
...
func (e *PluginEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Plugin; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PluginEntity) DataTyped(data ...Plugin) Plugin {
	if len(data) > 0 {
		return typedFrom[Plugin](e.Data(asMap(data[0])))
	}
	return typedFrom[Plugin](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Plugin (all fields
// optional at the wire level).
func (e *PluginEntity) MatchTyped(match ...Plugin) Plugin {
	if len(match) > 0 {
		return typedFrom[Plugin](e.Match(asMap(match[0])))
	}
	return typedFrom[Plugin](e.Match())
}
...
func (e *PluginEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PluginEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PluginLoadMatch and returns an Plugin. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *PluginEntity) LoadTyped(reqmatch PluginLoadMatch, ctrl map[string]any) (Plugin, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Plugin{}, err
	}
	return typedFrom[Plugin](res), nil
}



func (e *PluginEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *PluginEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PluginEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PluginEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PluginEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
