...
func NewPluginApiEntity(client *core.CtpSDK, entopts map[string]any) *PluginApiEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PluginApiEntity) GetName() string { return e.name }
...
func (e *PluginApiEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PluginApiEntity) Deleted() bool {
	return e.deleted
}


func (e *PluginApiEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPluginApiEntity(e.client, opts)
}

func (e *PluginApiEntity) Data(args ...any) any {
...
func (e *PluginApiEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an PluginApi; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PluginApiEntity) DataTyped(data ...PluginApi) PluginApi {
	if len(data) > 0 {
		return typedFrom[PluginApi](e.Data(asMap(data[0])))
	}
	return typedFrom[PluginApi](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through PluginApi (all fields
// optional at the wire level).
func (e *PluginApiEntity) MatchTyped(match ...PluginApi) PluginApi {
	if len(match) > 0 {
		return typedFrom[PluginApi](e.Match(asMap(match[0])))
	}
	return typedFrom[PluginApi](e.Match())
}
...
func (e *PluginApiEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PluginApiEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PluginApiLoadMatch and returns an PluginApi. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *PluginApiEntity) LoadTyped(reqmatch PluginApiLoadMatch, ctrl map[string]any) (PluginApi, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return PluginApi{}, err
	}
	return typedFrom[PluginApi](res), nil
}



func (e *PluginApiEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *PluginApiEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PluginApiEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PluginApiEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PluginApiEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
