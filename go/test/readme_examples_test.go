...
const testSeed = `map[string]any{"entity": map[string]any{"json_api": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "plugin": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "plugin_api": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
