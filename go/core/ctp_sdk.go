...
func (sdk *CtpSDK) OptionsMap() map[string]any {
...
func (sdk *CtpSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *CtpSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *CtpSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *CtpSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *CtpSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *CtpSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("CtpSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *CtpSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *CtpSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("CtpSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
